...
if (isset($_POST['move_stock'])) {
    ...
    // We get a combined value "BatchID|LocationID" from the dropdown
    $source_signature = $_POST['source_stock_signature'];
    ...
    if ($source_row && $source_row['quantity'] >= $move_qty) {
        ...
        // A. DECREASE from Old Location (Using Item+Batch+Location as the "Key")
...
if (isset($_POST['qr_code'])) {
    ...
    if (filter_var($code, FILTER_VALIDATE_URL)) {
        ...
        if (mysqli_num_rows($result) > 0) {
            ...
            // Find WHERE this item is (Using Batch + Location logic, NO 'id')
            ...
            if (empty($available_stock)) {
                $message = "⚠️ Item found, but Stock is 0. Cannot move.";
                $message_type = "error";
                $scanned_item = null;
            }
        } else {
        ...
        <?php if ($scanned_item): ?>
            <div class="result-card">
                ...
                <form method="POST">
                    ...
                    <div style="text-align:left; font-weight:bold; margin-bottom:5px; color:#4b5563;">1. Move From (Source)</div>
                    ...
                    <div style="text-align:left; font-weight:bold; margin-bottom:5px; color:#4b5563;">3. Quantity to Move</div>
